...
const LESSONS = [
  ...
  { id: "equity", cat: "basics", title: "③ エクイティとアウツ(2/4の法則)", body:
    ...
    <p><b>コンボドロー(複合ドロー)は強烈です。</b>アウツは重複を除いて足し算します:</p>
    <ul>
    <li>フラッシュドロー(9)+両面ストレート(8)で1枚重複 → <b>約15アウツ</b> → フロップで完成率 <b>約54%</b>(メイドハンド相手でも互角以上!)</li>
    <li>フラッシュドロー(9)+ガットショット(4) → <b>約12アウツ</b> → 約48%</li>
    <li>これらは<b>セミブラフ</b>の最有力候補。降ろせれば即利益、コールされても高い完成率で勝てる二重の勝ち筋(だから大きく打てる)。</li>
    </ul>
